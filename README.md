...
4. Send any supporting documentation to [support@miataregistry.com](mailto:support@miataregistry.com) to get verified faster; this can be photos, social media links, PDF files showing vehicle history, etc.
...
1. Create a `.dev.vars` and `.env` file in the root directory with your environment variables. Reach out to a maintainer to get the correct values.
2. Start the development application and worker:
