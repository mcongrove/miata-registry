...
export const CSP = () => {
	useEffect(() => {
		...
		meta.content = `
			...
			script-src 'self' 'unsafe-inline' 'unsafe-eval' *.googleapis.com *.clerk.accounts.dev *.cloudflareinsights.com clerk.miataregistry.com challenges.cloudflare.com kit.fontawesome.com ${devCSP}; 
