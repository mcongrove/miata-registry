...
export const Select = ({
	...
	<div className="relative">
		<select
			{...props}
			className={SelectStyles(disabled, className || '')}
			onChange={onChange}
			value={value || ''}
			disabled={disabled}
		>
