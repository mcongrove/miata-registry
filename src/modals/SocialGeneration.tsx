	...
	const generateSocialImage = () => (
		...
		>
			...
			>
				...
				>
					<path d="M0,0 L1080,0 L1080,309 L0,675 Z" fill="#E8EBEA" />
				</svg>
			</div>
			...
			<div
				style={{
					...
					top: '71px',
					right: '50px',
					border: `5px solid ${colorMapSocial[car.edition?.color?.toLowerCase() || 'various']}`,
			...
			>
				{car.sequence !== null ? (
					<>
						{car.sequence &&
							car.sequence > (car.edition?.total_produced || 0) &&
							'Serial '}
						#<span style={{ fontWeight: 500 }}>{car.sequence}</span>{' '}
